const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '本州最南端の碑',
      image: '',
      tweet_id: '1418685312436482050',
      description: '<p>3巻 P64  和歌山県東牟婁郡 串本町 </p><div class="tweetContainer" id="tweet1418685312436482050"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '潮岬観光タワー',
      image: '',
      tweet_id: '1418456837062631426',
      description: '<p>3巻 P71  和歌山県東牟婁郡 串本町 </p><div class="tweetContainer" id="tweet1418456837062631426"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '新宮駅',
      image: '',
      tweet_id: '1418516877559570432',
      description: '<p>3巻 P80  和歌山県新宮市 徐福一丁目3</p><div class="tweetContainer" id="tweet1418516877559570432"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '熊野本宮大社',
      image: '',
      tweet_id: '1418371448192659458',
      description: '<p>3巻 P82  和歌山県田辺市 本宮町本宮</p><div class="tweetContainer" id="tweet1418371448192659458"></div> ',
      location: {
