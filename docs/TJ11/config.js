const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '新宮駅',
      image: '',
      tweet_id: '1476405478045462530',
      description: '<p>3巻 P80  和歌山県新宮市 徐福一丁目3</p><div class="tweetContainer" id="tweet1476405478045462530"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '熊野本宮大社',
      image: '',
      tweet_id: '1476422961817358339',
      description: '<p>3巻 P82  和歌山県田辺市 本宮町本宮</p><div class="tweetContainer" id="tweet1476422961817358339"></div> ',
      location: {
