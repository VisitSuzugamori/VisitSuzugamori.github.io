const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '新宮駅',
      image: '',
      tweet_id: '1458009712767635458',
      description: '<p>3巻 P80  和歌山県新宮市 徐福一丁目3</p><div class="tweetContainer" id="tweet1458009712767635458"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '熊野本宮大社',
      image: '',
      tweet_id: '1459393968458944512',
      description: '<p>3巻 P82  和歌山県田辺市 本宮町本宮</p><div class="tweetContainer" id="tweet1459393968458944512"></div> ',
      location: {
