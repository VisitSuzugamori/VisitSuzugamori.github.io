const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '潮岬灯台',
      image: '',
      tweet_id: '1571363303279951873',
      description: '<p>3巻 P62  和歌山県東牟婁郡 串本町 </p><div class="tweetContainer" id="tweet1571363303279951873"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '本州最南端の碑',
      image: '',
      tweet_id: '1571359509490049027',
      description: '<p>3巻 P64  和歌山県東牟婁郡 串本町 </p><div class="tweetContainer" id="tweet1571359509490049027"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '潮岬観光タワー',
      image: '',
      tweet_id: '1571358325677166592',
      description: '<p>3巻 P71  和歌山県東牟婁郡 串本町 </p><div class="tweetContainer" id="tweet1571358325677166592"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '新宮駅',
      image: '',
      tweet_id: '1570951315492044802',
      description: '<p>3巻 P80  和歌山県新宮市 徐福一丁目3</p><div class="tweetContainer" id="tweet1570951315492044802"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '熊野本宮大社',
      image: '',
      tweet_id: '1571384874736685057',
      description: '<p>3巻 P82  和歌山県田辺市 本宮町本宮</p><div class="tweetContainer" id="tweet1571384874736685057"></div> ',
      location: {
