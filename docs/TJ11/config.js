const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '本州最南端の碑',
      image: '',
      tweet_id: '1403994220881494016',
      description: '<p>3巻 P64  和歌山県東牟婁郡 串本町 </p><div class="tweetContainer" id="tweet1403994220881494016"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '熊野本宮大社',
      image: '',
      tweet_id: '1403253164636217345',
      description: '<p>3巻 P82  和歌山県田辺市 本宮町本宮</p><div class="tweetContainer" id="tweet1403253164636217345"></div> ',
      location: {
