const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '本州最南端の碑',
      image: '',
      tweet_id: '1589423832930127872',
      description: '<p>3巻 P64  和歌山県東牟婁郡 串本町 </p><div class="tweetContainer" id="tweet1589423832930127872"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '熊野本宮大社',
      image: '',
      tweet_id: '1589528351743840256',
      description: '<p>3巻 P82  和歌山県田辺市 本宮町本宮</p><div class="tweetContainer" id="tweet1589528351743840256"></div> ',
      location: {
