const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '潮岬灯台',
      image: '',
      tweet_id: '1603606420850675712',
      description: '<p>3巻 P62  和歌山県東牟婁郡 串本町 </p><div class="tweetContainer" id="tweet1603606420850675712"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '熊野本宮大社',
      image: '',
      tweet_id: '1605455994384941058',
      description: '<p>3巻 P82  和歌山県田辺市 本宮町本宮</p><div class="tweetContainer" id="tweet1605455994384941058"></div> ',
      location: {
