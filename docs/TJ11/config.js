const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '新宮駅',
      image: '',
      tweet_id: '1601083937815597057',
      description: '<p>3巻 P80  和歌山県新宮市 徐福一丁目3</p><div class="tweetContainer" id="tweet1601083937815597057"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '熊野本宮大社',
      image: '',
      tweet_id: '1602528223459278848',
      description: '<p>3巻 P82  和歌山県田辺市 本宮町本宮</p><div class="tweetContainer" id="tweet1602528223459278848"></div> ',
      location: {
