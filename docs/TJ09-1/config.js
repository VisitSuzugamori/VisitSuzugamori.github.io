const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '海老名SA (下り)',
      image: '',
      tweet_id: '1543378480145960961',
      description: '<p>2巻 P141  神奈川県海老名市 大谷南五丁目2</p><div class="tweetContainer" id="tweet1543378480145960961"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '広島駅',
      image: '',
      tweet_id: '1540602582745640960',
      description: '<p>2巻 P146  広島県広島市 南区 松原町1</p><div class="tweetContainer" id="tweet1540602582745640960"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '宮島口駅',
      image: '',
      tweet_id: '1543068483432239104',
      description: '<p>2巻 P147  広島県廿日市市 宮島口一丁目3</p><div class="tweetContainer" id="tweet1543068483432239104"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '宮島桟橋',
      image: '',
      tweet_id: '1540969569056980992',
      description: '<p>2巻 P151  広島県廿日市市 宮島町873</p><div class="tweetContainer" id="tweet1540969569056980992"></div> ',
      location: {
