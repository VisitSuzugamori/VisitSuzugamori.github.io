const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '海老名SA (下り)',
      image: '',
      tweet_id: '1535736650118090753',
      description: '<p>2巻 P141  神奈川県海老名市 大谷南五丁目2</p><div class="tweetContainer" id="tweet1535736650118090753"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '広島駅',
      image: '',
      tweet_id: '1537208203834015747',
      description: '<p>2巻 P146  広島県広島市 南区 松原町1</p><div class="tweetContainer" id="tweet1537208203834015747"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '宮島口駅',
      image: '',
      tweet_id: '1535955587128868864',
      description: '<p>2巻 P147  広島県廿日市市 宮島口一丁目3</p><div class="tweetContainer" id="tweet1535955587128868864"></div> ',
      location: {
    ...
    },
    {
      ...
      image: '',
      tweet_id: '1538000596447670273',
      description: '<p>2巻 P148  広島県廿日市市 宮島口一丁目5</p><div class="tweetContainer" id="tweet1538000596447670273"></div> ',
      location: {
