const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '両子寺',
      image: '',
      tweet_id: '1454318914901405697',
      description: '<p>5巻 P105  大分県国東市 </p><div class="tweetContainer" id="tweet1454318914901405697"></div> ',
      location: {
    ...
    },
    {
      ...
      title: 'USA（宇佐）神宮',
      image: '',
      tweet_id: '1452068563628412934',
      description: '<p>5巻 P108  大分県宇佐市 南宇佐2859</p><div class="tweetContainer" id="tweet1452068563628412934"></div> ',
      location: {
