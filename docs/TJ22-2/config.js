const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      image: '',
      tweet_id: '',
      description: '<p>   北海道網走市 </p> <p><img alt="2016-09-29 15.35.51" src="https://live.staticflickr.com/8555/30407843015_1000704c94_z.jpg"></p><p>photo from <a rel="noopener" href="https://www.flickr.com/search/?lat=44.0124153&amp;lon=144.1156977&amp;radius=0.1&amp;has_geo=1&amp;view_all=1">Flickr</a>【2016-09-29 15.35.51】 by Vokashots</p>',
      location: {
    ...
    },
    {
      ...
      title: '能取岬',
      image: '',
      tweet_id: '1540621017026297856',
      description: '<p>   北海道網走市 </p><div class="tweetContainer" id="tweet1540621017026297856"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '天に続く道スタート地点',
      image: '',
      tweet_id: '1540522189333696514',
      description: '<p>   北海道斜里郡 斜里町 </p><div class="tweetContainer" id="tweet1540522189333696514"></div> ',
      location: {
