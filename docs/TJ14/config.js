const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '立川駅',
      image: '',
      tweet_id: '1468372747726487553',
      description: '<p>4巻 P96  東京都立川市 柴崎町三丁目1</p><div class="tweetContainer" id="tweet1468372747726487553"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '青梅駅',
      image: '',
      tweet_id: '1468812593062203394',
      description: '<p>4巻 P97  東京都青梅市 本町131</p><div class="tweetContainer" id="tweet1468812593062203394"></div> ',
      location: {
