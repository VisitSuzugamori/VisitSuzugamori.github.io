const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '京都駅',
      image: '',
      tweet_id: '1579253441313968128',
      description: '<p>2巻 P6  京都府京都市 下京区 東塩小路町676</p><div class="tweetContainer" id="tweet1579253441313968128"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '伏見稲荷駅',
      image: '',
      tweet_id: '1579292530570825729',
      description: '<p>2巻 P18  京都府京都市 伏見区 深草一ノ坪町20</p><div class="tweetContainer" id="tweet1579292530570825729"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '宮津駅',
      image: '',
      tweet_id: '1579038726784622592',
      description: '<p>2巻 P21  京都府宮津市 字鶴賀2099</p><div class="tweetContainer" id="tweet1579038726784622592"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '富田屋',
      image: '',
      tweet_id: '1580771647065559041',
      description: '<p>2巻 P22  京都府宮津市 字鶴賀2066</p><div class="tweetContainer" id="tweet1580771647065559041"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '天橋立ビューランド',
      image: '',
      tweet_id: '1580446567471157248',
      description: '<p>2巻 P32  京都府宮津市 文珠1</p><div class="tweetContainer" id="tweet1580446567471157248"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '天橋立',
      image: '',
      tweet_id: '1579699496841535488',
      description: '<p>2巻 P35  京都府宮津市 字江尻927</p><div class="tweetContainer" id="tweet1579699496841535488"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '天橋立神社',
      image: '',
      tweet_id: '1581614476369203200',
      description: '<p>2巻 P39  京都府宮津市 字文珠</p><div class="tweetContainer" id="tweet1581614476369203200"></div> ',
      location: {
