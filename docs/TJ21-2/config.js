const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '湯倉神社',
      image: '',
      tweet_id: '1501746627391868928',
      description: '<p>   北海道函館市 湯川町二丁目28</p><div class="tweetContainer" id="tweet1501746627391868928"></div> ',
      location: {
    ...
    },
    {
      ...
      image: '',
      tweet_id: '',
      description: '<p>   北海道函館市 湯川町三丁目13</p> <p><img alt="DSC_0670" src="https://live.staticflickr.com/4288/34677861904_227036b6d7_z.jpg"></p><p>photo from <a rel="noopener" href="https://www.flickr.com/search/?lat=41.7776852&amp;lon=140.7931866&amp;radius=0.1&amp;has_geo=1&amp;view_all=1">Flickr</a>【DSC_0670】 by ccc20135</p>',
      location: {
    ...
    },
    {
      ...
      title: '立待岬',
      image: '',
      tweet_id: '1501387623335665667',
      description: '<p>   北海道函館市 住吉町15</p><div class="tweetContainer" id="tweet1501387623335665667"></div> ',
      location: {
