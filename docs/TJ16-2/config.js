const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '御岩神社',
      image: '',
      tweet_id: '1502177446149627907',
      description: '<p>5巻 P36  茨城県日立市 </p><div class="tweetContainer" id="tweet1502177446149627907"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '日立駅',
      image: '',
      tweet_id: '1502164739266588672',
      description: '<p>5巻 P51  茨城県日立市 旭町一丁目3</p><div class="tweetContainer" id="tweet1502164739266588672"></div> ',
      location: {
