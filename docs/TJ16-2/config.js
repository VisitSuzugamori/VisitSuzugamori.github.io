const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: '御岩神社',
      image: '',
      tweet_id: '1548882702903808001',
      description: '<p>5巻 P36  茨城県日立市 </p><div class="tweetContainer" id="tweet1548882702903808001"></div> ',
      location: {
    ...
    },
    {
      ...
      title: '日立駅',
      image: '',
      tweet_id: '1548751654321004544',
      description: '<p>5巻 P51  茨城県日立市 旭町一丁目3</p><div class="tweetContainer" id="tweet1548751654321004544"></div> ',
      location: {
